...
function print_state2(hstate_id){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var option_str = document.getElementById(hstate_id);
	option_str.length=0;
...
function print_city2(hcity_id, hcity_index){
	var option_str = document.getElementById(hcity_id);
	option_str.length=0;	// Fixed by Julian Woods
	option_str.options[0] = new Option('Select city/district','');
	option_str.selectedIndex = 0;
	var city_arr = s_a[hcity_index].split("|");
